...
//   return (
//     <View className="mb-3 rounded-xl border p-4 bg-white border-gray-200 dark:bg-[#020617] dark:border-[#1e293b]">
//       <Text className="text-xs text-gray-500 dark:text-[#9ca3af]">
//         {label}
//       </Text>
      
//       <Text className="text-xl font-bold mt-1 text-gray-900 dark:text-[#e5e7eb]">
//         {value}
//       </Text>
